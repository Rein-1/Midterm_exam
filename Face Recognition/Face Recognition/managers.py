...
import cv2
import numpy as np  # Corrected the import for numpy
import time

class CaptureManager(object):
    def __init__(self, capture, previewWindowManager=None, shouldMirrorPreview=False):
        self.previewWindowManager = previewWindowManager
        self.shouldMirrorPreview = shouldMirrorPreview  # Corrected a typo
        ...
        self._videoEncoding = None  # Corrected a typo
    ...
    def startWritingVideo(self, filename, encoding=cv2.VideoWriter_fourcc('I', '4', '2', '0')):
        ...
        self._videoEncoding = encoding  # Corrected a typo
        ...
        if self._videoWriter is None:
            ...
            if fps == 0.0:
                ...
                self._videoWriter = cv2.VideoWriter(self._videoFilename,
                                                    self._videoEncoding,
                                                    fps, size)
            self._videoWriter.write(self._frame)  # Corrected a typo
